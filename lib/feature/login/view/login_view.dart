                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextField(
                          decoration: _decoration(AppPath.logoEmail, 'Input your email'),
                        ...
                        const SizedBox(height: 8),
                        TextField(
                          decoration: _decoration(AppPath.topic_1,'Input your password'),
                          obscureText: true,
                        ...
                        Row(
                          ...
                          children: [
                            SvgPicture.asset(AppPath.logoEmail),
                            SvgPicture.asset(AppPath.logoApple),
                            SvgPicture.asset(AppPath.logoGoogle)
                          ],
                        ),
                      ],
                    ),
...
InputDecoration _decoration(String path, String hint){
